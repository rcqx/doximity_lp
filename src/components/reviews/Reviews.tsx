...
const Reviews = () => {
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-start gap-8 xl:gap-16">
      <div className="pt-28 flex flex-col items-center justify-center">
        <h1 className="text-[30px] font-bold text-center">
          The reviews are in
        </h1>
        <p className="text-base my-[17px] text-center w-5/6 xl:w-full">
      ...
      {selected[0] > 0 && (
        ...
        >
          <blockquote className="text-base xl:text-[24px] w-[90%] xl:w-1/2 text-center tracking-tight leading-8">
